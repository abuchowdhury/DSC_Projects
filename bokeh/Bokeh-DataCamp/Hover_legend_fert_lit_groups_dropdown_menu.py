...
p1.circle('x', 'y', size={'field': 'data.population', 'transform': size_mapper},
    color={'field': 'data.Continent', 'transform': color_mapper},
    alpha=0.6,
    source=source,
    legend='data.Continent')
...
p2.circle('x', 'y', size={'field': 'data.population', 'transform': size_mapper},
    color={'field': 'data.Continent', 'transform': color_mapper},
    alpha=0.6,
    source=source,
    legend='data.Continent')
