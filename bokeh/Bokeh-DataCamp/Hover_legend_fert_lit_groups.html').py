...
PLOT_OPTS1 = dict(
        height=700, width=700, x_axis_type='log', x_range=(.5, 7.15), y_range=(10, 100)
) 

PLOT_OPTS2 = dict(
        height=700, width=700, x_axis_type='log', y_axis_type='log', x_range=(.5, 7.15), y_range=(10000, 1500000000)
)
